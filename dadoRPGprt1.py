...
def inicio():
    # Introducción de la misión del juego
    print("El rey Baldor te ha encomendado una misión urgente: detener los ataques orcos que han devastado el reino.")
...
def seleccionar_clase():
    # Selección de la clase del personaje
    while True:
        try:
...
def distribuir_atributos():
    # Distribución de puntos de atributos
...
def main():
    try:
        ...
        print(f"Error inesperado: {e}. Fin del juego.")
        exit()
